   ...
   <div class="col-md-2">
    <h4>
      ...
      <thead>
        ...
        <tbody>
          <tr>
            <td><a href="kategori1_nonlogin.php" id="k1">Pakaian Wanita</a></td>
          </tr>
          <tr>
            <td><a href="kategori2_nonlogin.php" id="kategori_a">Pakaian Pria</a></td>
          </tr>
          <tr>
            <td><a href="kategori3_nonlogin.php" id="kategori_a">Celana</a></td>
          </tr>
          <tr>
            <td><a href="kategori4_nonlogin.php" id="kategori_a">Rok</a></td>
          </tr>
          <tr>
            <td><a href="kategori5_nonlogin.php" id="kategori_a">Pakaian Muslim</a></td>
          </tr>
        </tbody>
      </table>
    </div>
